...
import { IViewPointBiz } from '@store';
...
@Component({
  selector: 'app-information-window-a',
...
export class InformationWindowComponent {
  ...
  //#region Event
  @Output()
  viewPointClickedEvent: Subject<IViewPointBiz>;
  @Output()
  viewPointAddedEvent: Subject<IViewPointBiz>;
  @Output()
  viewPointRemovedEvent: Subject<IViewPointBiz>;
  ...
  @Input()
  public actionAllowed: ActionAllowed;
  @Input()
  public viewPoint: IViewPointBiz;
  //#endregion
  ...
  getStyle() {
    return {
      'background-color':
        this.actionAllowed === ActionAllowed.NONE ? '#ffffff;' : '#e6e0e0;',
    };
  }
