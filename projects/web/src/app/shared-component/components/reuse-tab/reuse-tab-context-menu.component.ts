...
import { CloseType, ReuseContextCloseEvent, ReuseContextI18n, ReuseItem } from '../../interfaces/reuse-tab/interface';

@Component({
  selector: 'bt-reuse-tab-context-menu',
  template: `
  <ul nz-menu>
      ...
      <li nz-menu-item (click)="click($event, 'closeRight')" data-type="closeRight"
      [nzDisabled]="item.last" [innerHTML]="i18n.closeRight"></li>
