...
} from '../bizModel/model/viewPoint.biz.model';
...
const viewPointData: IViewPointBiz = {
  ...
  comments: [],
  countOfComments: 0,
  images: ['assets/img/IMG_4203.jpg', 'assets/img/IMG_4204.jpg'],
...
describe('flush test', () => {
  beforeEach(async () => {
    ...
    let req = httpTestingController.expectOne(
      'http://localhost:3000/transportationCategories',
    );
  ...
  describe('dirty logic', () => {
    it('#success add(), followed by failed change()', () => {
      const addedTravelAgenda = Object.assign({}, travelAgendaData, {
        dailyTrips: [],
      });
      ...
      // 2. Change
      const changedTravelAgenda = Object.assign({}, travelAgendaData, {
        name: '黄山1',
      });
