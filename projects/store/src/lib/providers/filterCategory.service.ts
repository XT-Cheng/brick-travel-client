...
import {
  FilterTypeEnum,
  IFilterCategoryBiz,
} from '../bizModel/model/filterCategory.biz.model';
...
@Injectable()
export class FilterCategoryService extends EntityService<
  IFilterCategory,
  IFilterCategoryBiz
> {
  //#region Constructor
  ...
  private buildCurrentFilterCategories(
    checkIds: string[],
    categories: IFilterCategoryBiz[],
  ) {
